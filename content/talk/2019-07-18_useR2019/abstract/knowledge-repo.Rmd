...
zip <- zip::zip(zipfile = "source_code_pdf.zip", 
                files = files,
...
The source code for generating this abstract is available [here](https://kwb-r.gitlab.io/fakin/talk/2019-07-18_user2019/abstract/source_code_pdf.zip), **Current version**: March 1, 2019; **Corresponding author**: michael.rustler@kompetenz-wasser.de"
