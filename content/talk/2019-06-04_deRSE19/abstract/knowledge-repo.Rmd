...
zip <- zip::zip(zipfile = "source_code.zip", 
                files = files,
...
<!-- The source code for generating this abstract is available [here](https://kwb-r.gitlab.io/fakin/talk/2019-06-04_derse19/abstract/source_code.zip), **Current version**: `r format(Sys.time(), '%B %d, %Y')`; **Corresponding author**: michael.rustler@kompetenz-wasser.de" -->
